...
public abstract class CameraBridgeViewBase extends SurfaceView implements SurfaceHolder.Callback {
    ...
    protected Size calculateCameraFrameSize(List<?> supportedSizes, ListItemAccessor accessor, int surfaceWidth, int surfaceHeight) {
        ...
        if (surfaceWidth <= mMaxWidth){ //If the screen is physically not wide enough to accept the frame, scale the larger image to fit
            maxAllowedWidth = mMaxWidth;
            maxAllowedHeight = mMaxHeight;
        }else { //if the required image is narrower than the screen automatically select the widest image.
